...
export const environment = {
  ...
  api: {
    ...
    // mssivimss: 'http://sivimss-ds.apps.ocp.imss.gob.mx/mssivimss-ctrol-permisos/v1/sivimss/service/',
    // login: 'http://sivimss-ds.apps.ocp.imss.gob.mx/mssivimss-oauth/v1',

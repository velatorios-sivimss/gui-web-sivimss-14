...
export const environment = {
  ...
  api: {
    ...
    servicios_externos:
      'http://sivimss-qa.apps.ocp.imss.gob.mx/mssivimss-ser-externos/v1/catalogos/externos/',
    notificaciones:
      'https://sivimss-qa.apps.ocp.imss.gob.mx/mssivimss-notificaciones/v1/notificaciones/avisos',
  },
};

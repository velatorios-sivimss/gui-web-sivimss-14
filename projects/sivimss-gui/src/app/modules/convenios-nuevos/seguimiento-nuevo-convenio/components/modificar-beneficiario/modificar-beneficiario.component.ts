import { BeneficiarioInterface } from './../../../../convenios-prevision-funeraria/models/beneficiario.interface';
...
export class ModificarBeneficiarioComponent implements OnInit {

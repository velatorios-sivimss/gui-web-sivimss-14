...
export class PreRegistroContratacionNuevoConvenioComponent {
  ...
  inicializarFormulario(): void {
    ...
    this.contratacionNuevoConvenioForm = this.formBuilder.group({
      persona: this.formBuilder.group({
        ...
        codigoPostal: [{value: this.convenioPersona?.cp.toString().padStart(5,'0'), disabled: false}, [Validators.required]],
        colonia: [{value: this.convenioPersona?.colonia, disabled: false}, [Validators.required]],
        municipio: [{value: this.convenioPersona?.municipio, disabled: true}, [Validators.required]],
        estado: [{value: this.convenioPersona?.estado, disabled: true}, [Validators.required]],
  ...
  inicializarFormularioEmpresa(): void {
    this.contratacionNuevoConvenioForm = this.formBuilder.group({
      empresa: this.formBuilder.group({
        ...
        cp: [{value: this.convenioEmpresa.cp.padStart(5,'0'), disabled: false}, [Validators.required]],
        ...
        telefono: [{value: this.convenioEmpresa.telefono, disabled: false}, [Validators.required]],
  ...
  agregarSolicitante(solicitante: PreRegistroPA): void {
    ...
    const solicitanteForm: FormGroup = this.formBuilder.group({
      ...
      colonia: [{value: solicitante.colonia, disabled: true}, [Validators.required]],
      municipio: [{value: solicitante.municipio, disabled: true}, [Validators.required]],

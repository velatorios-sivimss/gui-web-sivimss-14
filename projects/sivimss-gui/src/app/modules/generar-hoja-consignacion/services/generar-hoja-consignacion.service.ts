...
import { BuscarCatalogo, BuscarGenerarHojaConsignacion, GenerarHojaConsignacion } from '../models/generar-hoja-consignacion.interface';
...
export class GenerarHojaConsignacionService extends BaseService<HttpRespuesta<any>, any> {
  ...
  reporteHojaConsignacion(reporteHojaConsignacion: any): Observable<HttpRespuesta<any>> {
    return this._http.post<HttpRespuesta<any>>(this._base + `${this._funcionalidad}/reporte-hoja-consig/generarDocumento/pdf`, reporteHojaConsignacion);
  }

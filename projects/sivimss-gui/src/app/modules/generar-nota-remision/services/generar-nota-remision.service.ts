...
import {ConsultaNotaRemision, GenerarDatosReporte} from '../models/nota-remision.interface';
...
export class GenerarNotaRemisionService extends BaseService<HttpRespuesta<any>, any> {
  ...
  generarReporteTabla(generarReporte: any): Observable<HttpRespuesta<any>> {

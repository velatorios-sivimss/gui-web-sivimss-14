...
import {
  CatalogoFolioODS,
  CatalogoVelatorio,
  CatalogoContratantes, CatalogoFinado
...
import {CancelarOrdenServicioSFComponent,} from "../cancelar-orden-servicio/cancelar-orden-servicio.component";
...
export class OrdenesServicioSFComponent implements OnInit {
  ...
  abrirModalCancelarODS(): void {
    const ref = this.dialogService.open(CancelarOrdenServicioSFComponent, {
      header: 'Cancelar ODS',
      style: {maxWidth: '876px', width: '100%'},
      data: {
        ods: this.ordenServicioSeleccionada
  ...
  modificarODS(): void {
    void this.router.navigate(["ordenes-de-servicio/ods-plan-sf/modificar-ods-sf"],

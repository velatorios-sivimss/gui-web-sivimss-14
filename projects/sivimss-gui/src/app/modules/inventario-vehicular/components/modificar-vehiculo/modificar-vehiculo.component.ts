...
export class ModificarVehiculoComponent {
  ...
  inicializarFormDatosDocumentacion(vehiculoSeleccionado: Vehiculo): void {
    this.datosDocumentacionForm = this.formBuilder.group({
      ...
      vigenciaTarjetaInicio: [{
        value: vehiculoSeleccionado.vigenciaTarjetaInicio,
        disabled: false
      }, [Validators.required]],
      ...
      vigenciaAdquisicionInicio: [{
        value: vehiculoSeleccionado.fechaVigenciaInicio,
        disabled: false
      }, [Validators.required]],
      ...
      vigenciapolizaInicio: [{
        value: vehiculoSeleccionado.vigenciapolizaInicio,
        disabled: false
      }, [Validators.required]],

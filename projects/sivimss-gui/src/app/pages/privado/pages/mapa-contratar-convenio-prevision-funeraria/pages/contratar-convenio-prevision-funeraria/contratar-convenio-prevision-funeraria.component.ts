...
export class ContratarConvenioPrevisionFunerariaComponent implements OnInit {
  ...
  get datosGrupo() {
    return (this.formPersona.controls['datosGrupo'] as FormGroup).controls;
  }
